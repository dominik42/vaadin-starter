...
import de.hub28.test.components.appnav.AppNav;
import de.hub28.test.components.appnav.AppNavItem;
import de.hub28.test.views.about.AboutView;
import de.hub28.test.views.addressform.AddressFormView;
import de.hub28.test.views.cardlist.CardListView;
import de.hub28.test.views.chat.ChatView;
import de.hub28.test.views.checkoutform.CheckoutFormView;
import de.hub28.test.views.collaborativemasterdetail.CollaborativeMasterDetailView;
import de.hub28.test.views.creditcardform.CreditCardFormView;
import de.hub28.test.views.dashboard.DashboardView;
import de.hub28.test.views.helloworld.HelloWorldView;
import de.hub28.test.views.imagelist.ImageListView;
import de.hub28.test.views.list.ListView;
import de.hub28.test.views.map.MapView;
import de.hub28.test.views.masterdetail.MasterDetailView;
import de.hub28.test.views.personform.PersonFormView;
import de.hub28.test.views.richtexteditor.RichTextEditorView;
